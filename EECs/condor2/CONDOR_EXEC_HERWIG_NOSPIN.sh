...
cmsRun config/test_EEC_genonly.py inputjson=config/filelists/herwig_nospin_1000.json index=$1
echo "DONE RUNNING"

xrdcp NANO_$1.root root://cmseos.fnal.gov//store/user/srothman/herwig_nospin/
xrdcp dropped_$1.root root://cmseos.fnal.gov//store/user/srothman/herwig_nospin/
