...
cmsRun config/test_EEC_genonly.py inputjson=config/filelists/pythia_nobdecay_1000.json index=$1
echo "DONE RUNNING"

xrdcp NANO_$1.root root://cmseos.fnal.gov//store/user/srothman/pythia_nobdecay/
xrdcp dropped_$1.root root://cmseos.fnal.gov//store/user/srothman/pythia_nobdecay/
