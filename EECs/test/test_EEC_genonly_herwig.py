...
# Input source
from herwig_filelist import filelist
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('/ceph/submit/data/user/s/srothman/overnight/NANO_herwig.root'),
...
process.DroppedEventsOutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('/ceph/submit/data/user/s/srothman/overnight/dropped_herwig.root'),
