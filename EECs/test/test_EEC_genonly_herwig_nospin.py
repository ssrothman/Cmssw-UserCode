...
# Input source
from herwig_nospin_filelist import filelist
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('/ceph/submit/data/user/s/srothman/overnight/NANO_herwig_nospin.root'),
...
process.DroppedEventsOutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('/ceph/submit/data/user/s/srothman/overnight/dropped_herwig_nospin.root'),
