...
# Input source
from pythia_nospin_filelist import filelist
process.source = cms.Source("PoolSource",
    ...
    #fileNames = cms.untracked.vstring('file:test_pythia_nospin.root'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('/ceph/submit/data/user/s/srothman/overnight/NANO_pythia_nospin.root'),
...
process.DroppedEventsOutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('/ceph/submit/data/user/s/srothman/overnight/dropped_pythia_nospin.root'),
