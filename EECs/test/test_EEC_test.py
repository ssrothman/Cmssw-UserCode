...
process.source = cms.Source("PoolSource",
    ...
    #eventsToProcess = cms.untracked.VEventRange(cms.EventRange(1, 37080913, 1, 37080913))
)
...
process = setupAnalysis(process, ak8=True, addCharged=False, addNaive=False, 
                        addFullEvent=False, addRandomControl=False, addZControl=False,
                        verbose=1)
